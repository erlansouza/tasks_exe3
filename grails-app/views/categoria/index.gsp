		...
		<div id="list-categoria" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricaoCategoria" title="${message(code: 'categoria.descricaoCategoria.label', default: 'Descricao Categoria')}" />
				...
				<g:each in="${categoriaInstanceList}" status="i" var="categoriaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${categoriaInstance.id}">${fieldValue(bean: categoriaInstance, field: "descricaoCategoria")}</g:link></td>
